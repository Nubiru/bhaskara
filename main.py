...
# Registrar routers
app.include_router(bhaskara_router.router)
app.include_router(ingreso_total_router.router)
app.include_router(costo_total_router.router)
app.include_router(beneficio_router.router)
app.include_router(punto_equilibrio_router.router)